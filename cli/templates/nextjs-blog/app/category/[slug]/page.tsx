...
export default async function CategoryArchivePage({
  ...
  const { posts } = await getPosts({ category: slug, limit: 30 });
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10 space-y-10">
      ...
      <div className="border-b border-slate-200 pb-8 space-y-3">
        <div className="flex items-center gap-2 text-brand">
          ...
          <span className="text-xs font-black uppercase tracking-wider text-navy">Category Archive</span>
        </div>
      ...
      {posts.length === 0 ? (
        <div className="py-20 text-center space-y-3">
          <p className="text-base font-bold text-navy">No articles found in this category.</p>
