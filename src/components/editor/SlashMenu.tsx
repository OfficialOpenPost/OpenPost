...
export const slashItems: SlashItem[] = [
  ...
  { title: "Gallery", keywords: "gallery carousel grid", category: "Media", icon: LayoutGrid, command: ({ editor, range }) => editor.chain().focus().deleteRange(range).setGallery({ layout: "grid", images: [{ src: "https://picsum.photos/seed/1/600/400" }, { src: "https://picsum.photos/seed/2/600/400" }] }).run() },
  ...
  { title: "FAQ", keywords: "faq accordion", category: "Interactive", icon: ListTree, command: ({ editor, range }) => editor.chain().focus().deleteRange(range).setFaq({ items: [{ question: "What is OpenPost?", answer: "OpenPost is a headless CMS." }, { question: "How to use?", answer: "Add questions and answers." }] }).run() },
  ...
  { title: "Accordion", keywords: "accordion collapsible", category: "Layout", icon: Layers, command: ({ editor, range }) => editor.chain().focus().deleteRange(range).setAccordion({ items: [{ title: "Section 1", content: "Content..." }, { title: "Section 2", content: "More content..." }] }).run() },
