      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-black text-navy">OpenPost Publication</span>
          </div>

          <div className="flex items-center gap-6 text-xs font-semibold text-slate-500">
            <Link href="/" className="hover:text-navy transition">Home</Link>
            <Link href="/blog" className="hover:text-navy transition">All Articles</Link>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover:text-navy transition inline-flex items-center gap-1"
            >
        ...
        <div className="mt-8 border-t border-slate-100 pt-8 text-center text-xs text-slate-400">
          &copy; {new Date().getFullYear()} Powered by OpenPost — The Next-Gen Headless CMS &amp; Writing Studio.
        </div>
      </div>
    </footer>
  );
