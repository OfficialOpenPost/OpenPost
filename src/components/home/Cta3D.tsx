      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <FadeIn>
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm sm:text-base text-text-secondary leading-relaxed">
            Modern publishing without proprietary lock-in. Modular block editing, automated WebP compression,
            and a high-speed headless API — 100% free under the MIT License.
          </p>

          <div className="mt-8 flex flex-col items-center justify-center gap-3.5 sm:flex-row">
            <Link
              href="/signup"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-navy px-8 py-3.5 text-sm font-bold text-white shadow-md shadow-navy/15 hover:bg-navy-dark hover:scale-[1.02] transition"
            >
              Start Writing Free
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-white px-7 py-3.5 text-sm font-bold text-navy hover:bg-surface-dim hover:border-brand/40 transition shadow-xs"
            >
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-xs text-text-tertiary">
            ...
            <span>•</span>
            <span className="flex items-center gap-1.5 font-medium text-text-secondary">
              <Globe className="h-3.5 w-3.5 text-brand" /> Headless REST API
            </span>
            <span>•</span>
            <span className="flex items-center gap-1.5 font-medium text-text-secondary">
