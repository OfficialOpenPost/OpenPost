...
export const DOCS_SEARCH_INDEX: DocSearchItem[] = [
  ...
  // Deep Dives
  {
    ...
    category: "Deep Dive",
    slug: "architecture",
    description: "Full system architecture, tech stack, data flow, multi-tenancy model, and directory structure.",
    keywords: ["architecture", "system", "stack", "data flow", "directory"],
  },
  {
    title: "Database Schema Reference",
    category: "Deep Dive",
    slug: "database",
    description: "Complete Prisma schema reference with all models, relations, indexes, and ER diagram.",
    keywords: ["database", "prisma", "schema", "models", "relations", "postgresql"],
  },
  {
    title: "Content Format Specification",
    category: "Deep Dive",
    slug: "content-format",
    description: "ProseMirror JSON AST structure, block types, mark types, and content flow.",
    keywords: ["content", "format", "json", "ast", "proseMirror", "blocks", "marks"],
  },
  {
    title: "Authentication & Sessions",
    category: "Deep Dive",
    slug: "authentication",
    description: "Supabase Auth integration, session management, profile status workflow, and API tokens.",
    keywords: ["auth", "session", "supabase", "login", "token", "profile"],
  },
  {
    title: "RBAC Permissions Matrix",
    category: "Deep Dive",
    slug: "rbac",
    description: "5-tier role hierarchy, 60+ permissions matrix, and enforcement rules.",
    keywords: ["rbac", "roles", "permissions", "owner", "admin", "editor", "author"],
  },
  {
    title: "API Examples & Recipes",
    category: "Deep Dive",
    slug: "api-examples",
    description: "Complete curl examples for all endpoints with authentication, pagination, and error handling.",
    keywords: ["api", "examples", "curl", "recipes", "endpoints"],
  },
  {
    title: "SEO & Social Sharing",
    category: "Deep Dive",
    slug: "seo",
    description: "Per-post SEO settings, OG/Twitter tags, FAQ JSON-LD, sitemaps, RSS, and slug management.",
    keywords: ["seo", "og", "twitter", "json-ld", "sitemap", "rss", "meta"],
  },
  {
    title: "Environment Variables Reference",
    category: "Deep Dive",
    slug: "environment",
    description: "Complete environment variables reference with categories, public/private rules, and setup.",
    keywords: ["env", "environment", "variables", "config", "secrets"],
  },
  {
    title: "Contributing Guide",
    category: "Deep Dive",
    slug: "contributing",
    description: "Prerequisites, setup, code conventions, PR process, and test suites.",
    keywords: ["contributing", "development", "pr", "conventions", "testing"],
  },
  {
    title: "Editor Custom Blocks",
    category: "Deep Dive",
    slug: "editor-blocks",
    description: "All 11 custom editor blocks: Callout, Gallery, FAQ, Accordion, Button, Download, Poll, Video, Embed, Social, Image.",
    keywords: ["blocks", "callout", "gallery", "faq", "accordion", "poll", "video", "embed"],
  },
  {
    title: "Editor Extensions Reference",
    category: "Deep Dive",
    slug: "editor-extensions",
    description: "All Tiptap extensions: StarterKit, FontSize, LineHeight, TrailingNode, Link, Highlight, Table, and more.",
    keywords: ["extensions", "tiptap", "starterkit", "fontsize", "lineheight", "table"],
  },
  {
    title: "Frontend Editing Integration",
    category: "Deep Dive",
    slug: "frontend-editing",
    description: "REST API consumption, SharedRender rendering, ISR caching, preview mode, and webhook revalidation.",
    keywords: ["frontend", "integration", "api", "render", "isr", "preview"],
  },
  {
    title: "Media & Storage System",
    category: "Deep Dive",
    slug: "media-storage",
    description: "Cloudflare R2 setup, upload flow, magic bytes validation, WebP conversion, and 30+ image attributes.",
    keywords: ["media", "storage", "r2", "upload", "webp", "images"],
  },
  {
    title: "Webhooks API Reference",
    category: "Deep Dive",
    slug: "webhooks-api",
    description: "Webhook creation, HMAC-SHA256 verification, SSRF protection, GROQ filters, and deploy hooks.",
    keywords: ["webhooks", "hmac", "ssrf", "filters", "deploy"],
  },
];
