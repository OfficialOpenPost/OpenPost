      ...
      <section className="relative overflow-hidden rounded-3xl bg-navy p-8 sm:p-14 text-white shadow-xl">
        <div className="relative z-10 max-w-2xl space-y-4">
          <div className="inline-flex items-center gap-2 rounded-full bg-brand/20 px-3.5 py-1 text-xs font-black uppercase tracking-wider text-brand">
            <Sparkles className="h-3.5 w-3.5" /> {SITE_NAME}
          </div>
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight">
            {SITE_TAGLINE || "Ideas, insights, and stories engineered for performance."}
          </h1>
          <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
            {SITE_DESCRIPTION || `Welcome to ${SITE_NAME} — delivering ultra-fast headless publishing with interactive polls and structured content.`}
          </p>
